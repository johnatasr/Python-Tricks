...
class ChromeAuto:
    ...
    def clica_sign_in(self):
        try:
            btn_sign_in = self.chrome.find_element_by_class_name('HeaderMenu-link flex-shrink-0 no-underline mr-3')
            btn_sign_in.click()
    ...
    def faz_login(self):
        try:
            input_login = self.chrome.find_element_by_name('login')
...
if __name__ == '__main__':
    ...
    chrome.clica_perfil()
    chrome.verifica_usuario('otester')
